...
opportunities.
          ...
          >
            <motion.a 
              href="/checkout" 
              className="luxury-button text-black px-10 py-5 rounded-full font-bold text-md md:text-xl transform hover:scale-105 transition inline-block text-center relative z-10"
          ...
          <div className="space-y-12">
            ...
            <div className="text-center mt-16">
              <div className="glass-effect rounded-2xl p-8 max-w-4xl mx-auto">
                ...
                <motion.a 
                  href="/elite-premium" 
                  className="luxury-button text-black px-12 py-5 rounded-full font-bold text-md md:text-xl transform hover:scale-105 transition inline-block text-center relative z-10"
                  whileHover={{ scale: 1.05, y: -3 }}
                  whileTap={{ scale: 0.95 }}
                  transition={{ type: "spring", stiffness: 400, damping: 17 }}
                >
