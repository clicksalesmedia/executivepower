...
export default function CheckoutFormPage() {
  ...
  const packageId = searchParams.get('package') as keyof typeof packageData;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/checkout/${packageId}?amount=${parseInt(price!) * 100}&hasFormData=true&leadId=${lead.id}`);
    } catch (error) {
      ...
      <div className="min-h-screen bg-[#1B1C1D] py-12 px-6">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="gold-gradient">Your Information</span>
          </h1>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Please provide your details to proceed with your {packageInfo.name} package
          </p>
        </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <div className="space-y-4 mb-8">
                <div>
                  <h3 className="text-lg font-semibold text-white mb-2">{packageInfo.name}</h3>
              ...
              <div className="border-t border-yellow-200/20 pt-6">
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <span className="text-yellow-200 font-semibold text-sm">Secure & Confidential</span>
                </div>
                <p className="text-xs text-gray-400">
                  Your information is encrypted and processed securely. We never share your data with third parties.
                </p>
              </div>
            </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  {isSubmitting ? (
                    ...
                    `Continue to Payment - ${packageInfo.currency} ${packageInfo.price}`
                  )}
                </motion.button>
              </form>
            </motion.div>
